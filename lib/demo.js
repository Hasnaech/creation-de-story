...
export const STORIES_EXEMPLE = {
  ...
  stories: [
    {
      numero: 1,
      titre: "1 manager sur 2 vit ça",
      texte: "Tu poses des faits. Il répond avec des émotions. Tu documentes. Il accuse.",
      cta: "Ça te parle ? Reste là 👀",
      sticker: "sondage",
      suggestion_visuelle: "Vidéo selfie face caméra, regard direct, fond neutre de bureau",
      couleur_ambiance: "urgence",
    },
    {
      numero: 2,
      titre: "Le profil victimizer",
      texte: "Il retourne chaque recadrage contre toi. Et c'est toi qui finis par te justifier.",
      cta: "Tu en as un dans ton équipe ?",
      sticker: "question",
      suggestion_visuelle: "Texte sur fond sombre, zoom lent sur le mot « victimizer »",
      couleur_ambiance: "premium",
    },
    {
      numero: 3,
      titre: "Ce n'est pas toi le problème",
      texte: "Sans protocole clair, même les managers solides craquent. La toxicité prospère là où le système est flou.",
      cta: "Souffle. On va structurer ça.",
      sticker: "emoji_slider",
      suggestion_visuelle: "B-roll calme : carnet, café, respiration — rythme plus lent",
      couleur_ambiance: "confiance",
    },
    {
      numero: 4,
      titre: "9 profils, 9 protocoles",
      texte: "J'ai réuni les 9 profils comportementaux à risque, leurs tactiques et les protocoles adaptés, dans une grille gratuite.",
      cta: "Envoie PROFILS en DM 📩",
      sticker: "lien",
      suggestion_visuelle: "Aperçu de la grille (mockup téléphone), pages qui défilent",
      couleur_ambiance: "energie",
    },
    {
      numero: 5,
      titre: "Demain, même réunion ?",
      texte: "Soit tu revis la même scène la semaine prochaine, soit tu arrives avec un protocole.",
      cta: "PROFILS en DM — c'est gratuit",
      sticker: "compte_a_rebours",
      suggestion_visuelle: "Retour face caméra, sourire confiant, lumière chaude",
      couleur_ambiance: "energie",
    },
  ],
  conseil_publication: "Publiez la séquence entre 17h30 et 20h30 (créneau de vos posts qui percent), un mardi ou jeudi, en espaçant les stories de 30 à 60 minutes pour maximiser les retours dans les résultats du sondage.",
};
